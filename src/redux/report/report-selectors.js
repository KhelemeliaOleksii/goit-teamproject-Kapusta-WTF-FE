...
const getTransactionType = (state) => state.reportReducer.transaction.transaction;
const getTransactionDesc = (state) => state.reportReducer.transaction.transactionDesc;
